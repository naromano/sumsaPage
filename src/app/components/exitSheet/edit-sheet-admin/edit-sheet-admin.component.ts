...
@Component({
  selector: 'app-edit-sheet-admin',
  templateUrl: './edit-sheet-admin.component.html',
  styleUrl: './edit-sheet-admin.component.scss'
})
export class EditSheetAdminComponent implements OnInit {
  ...
  updateSheet(){
    ...
    const sheet: Sheet = {
      ...
      returnedMaterials: this.sheet.returnedMaterials,
    }
